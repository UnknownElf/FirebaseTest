$(document).ready(function(){
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyBgXRpM-E83oL3FpGBHSdEMaCOJGG5l75U",
    authDomain: "firetest2-2a62a.firebaseapp.com",
    databaseURL: "https://firetest2-2a62a.firebaseio.com",
    storageBucket: "firetest2-2a62a.appspot.com",
    messagingSenderId: "840717939796"
  };
  ...
  // Listening Login User
    firebase.auth().onAuthStateChanged(function(user){
      if(user) {
        ...
        dbChatRoom.limitToLast(16).on('child_added', function (snapshot) {
          //GET DATA
